...
[task_local]
#京东手机狂欢城
1 0-18/6 * * * https://raw.githubusercontent.com/w3334532/jd_scripts/master/jd_818.js?token=ABUHWDQEIGQV4RAWQQAB7NDACI37C, tag=京东手机狂欢城, enabled=true
// Loon
[Script]
cron "1 0-18/6 * * *" script-path=https://raw.githubusercontent.com/w3334532/jd_scripts/master/jd_818.js?token=ABUHWDQEIGQV4RAWQQAB7NDACI37C,tag=京东手机狂欢城
// Surge
京东手机狂欢城 = type=cron,cronexp=1 0-18/6 * * *,wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/w3334532/jd_scripts/master/jd_818.js?token=ABUHWDQEIGQV4RAWQQAB7NDACI37C
 */
...
function updateShareCodes(url = 'https://raw.githubusercontent.com/w3334532/updateTeam/master/jd_shareCodes.json') {
  return new Promise(resolve => {
    //https://cdn.jsdelivr.net/gh/w3334532/updateTeam@master/jd_shareCodes.json
    //https://raw.githubusercontent.com/w3334532/updateTeam/master/jd_shareCodes.json
...
function updateShareCodesCDN(url = 'https://raw.fastgit.org/w3334532/updateTeam/master/jd_shareCodes.json') {
  return new Promise(resolve => {
    //https://cdn.jsdelivr.net/gh/w3334532/updateTeam@master/jd_shareCodes.json
    //https://raw.githubusercontent.com/w3334532/updateTeam/master/jd_shareCodes.json
    $.get({url}, async (err, resp, data) => {
...
async function showMsg() {
  ...
  if (nowTime > new Date(activeEndTime).getTime()) {
    $.msg($.name, '活动已结束', `该活动累计获得京豆：${$.jbeanCount}个\niOS用户请删除此脚本\ngithub action用户请删除.github/workflows/jd_818.yml文件\n如果帮助到您可以点下🌟STAR鼓励我一下,谢谢\n咱江湖再见\nhttps://github.com/w3334532/jd_scripts`, {"open-url": "https://github.com/w3334532/jd_scripts"});
    if ($.isNode()) await notify.sendNotify($.name + '活动已结束', `请删除此脚本\ngithub action用户请删除.github/workflows/jd_818.yml文件\n如果帮助到您可以点下🌟STAR鼓励我一下,谢谢\n咱江湖再见\n https://github.com/w3334532/jd_scripts`)
  } else {
