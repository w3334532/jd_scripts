...
支持京东双账号
东东超市兑换奖品请使用此脚本 https://raw.githubusercontent.com/w3334532/jd_scripts/master/jd_blueCoin.js
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
=================QuantumultX==============
[task_local]
#东东超市
11 1-23/5 * * * https://raw.githubusercontent.com/w3334532/jd_scripts/master/jd_superMarket.js, tag=东东超市, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxc.png, enabled=true
===========Loon===============
[Script]
cron "11 1-23/5 * * *" script-path=https://raw.githubusercontent.com/w3334532/jd_scripts/master/jd_superMarket.js,tag=东东超市
=======Surge===========
东东超市 = type=cron,cronexp="11 1-23/5 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/w3334532/jd_scripts/master/jd_superMarket.js
==============小火箭=============
东东超市 = type=cron,script-path=https://raw.githubusercontent.com/w3334532/jd_scripts/master/jd_superMarket.js, cronexpr="11 1-23/5 * * *", timeout=3600, enable=true
 */
const $ = new Env('东东超市');
  ...
  if (smtg_getTeamPkDetailInfoRes && smtg_getTeamPkDetailInfoRes.data.bizCode === 0) {
    ...
    if (joinStatus === 0) {
      if (joinPkTeam === 'true') {
        ...
        if (!$.updatePkActivityIdRes) await updatePkActivityIdCDN('https://cdn.jsdelivr.net/gh/w3334532/updateTeam@master/jd_updateTeam.json');
...
//新版东东超市
function updatePkActivityId(url = 'https://raw.githubusercontent.com/w3334532/updateTeam/master/jd_updateTeam.json') {
  return new Promise(resolve => {
